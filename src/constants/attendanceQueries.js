...
//   GET_ALL_BY_USER: `SELECT * FROM attendance_records WHERE user_id = ? ORDER BY login_time DESC` // New query for all sessions
// };

const attendanceQueries = {
  INSERT_LOGIN: `
    INSERT INTO attendance_records 
    (user_id, site_id, site_name, login_time, login_location, device_name, status)
    VALUES (?, ?, ?, ?, ?, ?, 'logged_in')
  `,
  ...
  GET_ACTIVE_BY_USER: `
    ...
    WHERE user_id = ? AND status = 'logged_in' 
